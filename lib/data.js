...
/* the primary "live" link for a project — first non-GitHub link, if any */
export const primaryLive = (p) =>
  (p.links || []).find((l) => l.label !== "GitHub") || null;
